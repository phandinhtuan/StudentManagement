...
namespace StudentManagement.Models
{
    public class GroupStoreBase
    {
        ...
        internal void Create(StudentManagementDbContext.ApplicationGroup group)
        {
            throw new NotImplementedException();
        }

        internal void Delete(StudentManagementDbContext.ApplicationGroup group)
        {
            throw new NotImplementedException();
        }

        internal void Update(StudentManagementDbContext.ApplicationGroup group)
        {
            throw new NotImplementedException();
        }
    }
